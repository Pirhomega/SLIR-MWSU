import random
from constants import PARAMS, NUM_ROWS, NUM_COLS, LATENT_PERIOD_MAX, LATENT_PERIOD_MIN, INFECTIOUS_PERIOD_MAX, INFECTIOUS_PERIOD_MIN, MASK_CHANCE, QUARAN_CHANCE, SYMP_CHANCE, MAX_EXPOSURE
